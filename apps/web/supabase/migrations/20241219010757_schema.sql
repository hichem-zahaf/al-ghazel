 ...
 * -------------------------------------------------------
 */
-- Create a private Al-Ghazel schema
 ...
 * -------------------------------------------------------
 * Section: Accounts
 * We create the schema for the accounts. Accounts are the top level entity in the Supabase Al-Ghazel. They can be team or personal accounts.
 * -------------------------------------------------------
 */
-- Accounts table
...
comment on table public.accounts is 'Accounts are the top level entity in the Supabase Al-Ghazel';
