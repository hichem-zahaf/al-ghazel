...
BEGIN
  ...
  VALUES (
    ...
    'authenticated',
    'admin@al-ghazel.com',
    '$2a$10$viqzH/BVsGMhvq3oZP5OBO9xsmpuzMog35h2oKGbr6Xq/2L.fbPuC',
    NOW(),
    '{"name": "Admin User"}',
...
BEGIN
  ...
  VALUES
    ('aaaaaaaa-0001-0001-0001-000000000001', 'Fiction', 'fiction', '📚', 'Explore imaginary worlds and stories', 342),
    ('aaaaaaaa-0002-0002-0002-000000000002', 'Non-Fiction', 'non-fiction', '📖', 'Real stories and factual information', 256),
    ('aaaaaaaa-0003-0003-0003-000000000003', 'Mystery', 'mystery', '🔍', 'Suspenseful puzzles and thrillers', 189),
    ('aaaaaaaa-0004-0004-0004-000000000004', 'Romance', 'romance', '💕', 'Love stories and relationships', 234),
    ('aaaaaaaa-0005-0005-0005-000000000005', 'Science Fiction', 'sci-fi', '🚀', 'Futuristic worlds and technology', 178),
    ('aaaaaaaa-0006-0006-0006-000000000006', 'Fantasy', 'fantasy', '🐉', 'Magical worlds and mythical creatures', 267),
    ('aaaaaaaa-0007-0007-0007-000000000007', 'Biography', 'biography', '👤', 'Life stories of remarkable people', 145),
    ('aaaaaaaa-0008-0008-0008-000000000008', 'Self-Help', 'self-help', '💡', 'Personal development and growth', 198),
    ('aaaaaaaa-0009-0009-0009-000000000009', 'History', 'history', '🏛️', 'Events and stories from the past', 167),
    ('aaaaaaaa-0010-0010-0010-000000000010', 'Thriller', 'thriller', '⚡', 'Heart-pounding suspense', 201),
    ('aaaaaaaa-0011-0011-0011-000000000011', 'Children', 'children', '🧒', 'Books for young readers', 289),
    ('aaaaaaaa-0012-0012-0012-000000000012', 'Poetry', 'poetry', '✨', 'Beautiful verses and prose', 112);
EXCEPTION
  WHEN unique_violation THEN
    NULL; -- Ignore if already exists
END $$;
